...
type Dispatcher func(*client.Client, []interface{}, *store.Store) ([]byte, error)

func Execute(c *client.Client, args []interface{}, st *store.Store, dispatch Dispatcher) ([]byte, error) {
	if len(args) != 0 {
