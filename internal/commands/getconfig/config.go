...
func Execute(c *client.Client, args []interface{}, st *store.Store, cfg *config.Config) ([]byte, error) {
	if len(args) < 1 {
...
func GetConfig(c *client.Client, args []interface{}, st *store.Store, cfg *config.Config) ([]byte, error) {
